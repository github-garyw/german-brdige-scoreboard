                ...
                <tbody>
                    <tr v-for="round in rounds" :key="round.round">
                        ...
                        <td v-for="player in players" :key="player.key">
                            <span>
                                <NumberCell :value.sync=rounds[round.round].getBids[player.key] :editing=isBidding(round.round)></NumberCell>
                                <span v-show=!isBidding(round.round)>/</span>
                                <NumberCell v-show=!isBidding(round.round) :value.sync=player.result :editing=isGameStart(round.round)></NumberCell>
                                <span v-show=!isCurrentRound(round.round)>/</span>
                                <NumberCell v-show=!isCurrentRound(round.round) :value.sync=player.score :editing=false></NumberCell>
                            </span>
                        </td>
                        <td>
