                ...
                <tbody>
                    <tr v-for="round in rounds" :key="round.round">
                        ...
                        <td v-for="player in players" :key="player.key">
                            <span>
                                <NumberCell :value=player.bid :editing=isBidding(round.round)></NumberCell>
                                <span v-show=!isBidding(round.round)>/</span>
                                <NumberCell v-show=!isBidding(round.round) :value=player.result :editing=isGameStart(round.round)></NumberCell>
                                <span v-show=!isCurrentRound(round.round)>/</span>
                                <NumberCell v-show=!isCurrentRound(round.round) :value=player.score :editing=false></NumberCell>
                            </span>
                        </td>
                        <td>
